...
const btnClasses =
	'px-6 py-2 bg-orange-600 hover:bg-orange-700 rounded-lg text-white font-semibold shadow transition';
		...
		<div className='min-h-screen bg-gradient-to-br from-yellow-100 to-orange-50 p-6'>
			<header className='flex justify-between item-center mb-8'>
				...
				<nav className='flex gap-4'>
					<button className={btnClasses}>Create Custom Pizza</button>
